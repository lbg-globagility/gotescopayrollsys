...
Partial Public Class EmployeeForm
    ...
    Private _employeeLoanGridRows As List(Of DataGridViewRow)
...
#Region "Personal Profile"
    ...
    Private Async Sub Employee_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Await LoadFilterLoanTypesAsync()
        Await LoadFilterLoanStatusesAsync()

        Await LoadFilterOvertimeStatusAsync()
    End Sub
...
#Region "Loan Schedule"
    ...
    Private Sub fillloadsched()
        ...
        _employeeLoanGridRows = dgvLoanList.Rows?.OfType(Of DataGridViewRow)?.ToList()
    End Sub
...
#End Region
    ...
    Private Async Sub tbpleavebal_Enter(sender As Object, e As EventArgs) Handles tbpleavebal.Enter, TabPage7.Enter
        ...
        If CBool(leaveResetPerformed) Then
            ...
            txtlvotherbal.Text = txtothrbal.Text
        Else
    ...
    Private Async Function GetEmployeeLeaveBalances() As Task
        ...
        Using command = New MySqlCommand($"SELECT e.LeaveAllowance, e.LeaveBalance
                                         ...
                                         ,e.OtherLeaveAllowance, e.OtherLeaveBalance FROM employee e WHERE e.RowID={publicEmpRowID};",
                                         New MySqlConnection(connectionText))

            Await command.Connection.OpenAsync

            Dim dataReader = Await command.ExecuteReaderAsync

            While dataReader.Read
                Dim r = dataReader
                txtvlbal.Text = r("LeaveBalance")
                txtslbal.Text = r("SickLeaveBalance")
                txtmlbal.Text = r("MaternityLeaveBalance")
                txtaddvlbal.Text = r("AdditionalVLBalance")
                txtothrbal.Text = r("OtherLeaveBalance")
