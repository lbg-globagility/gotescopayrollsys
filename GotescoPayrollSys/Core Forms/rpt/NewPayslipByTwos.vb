...
Public Class NewPayslipByTwos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GotescoPayrollSys.NewPayslipByTwos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNewPayslipByTwos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NewPayslipByTwos = New NewPayslipByTwos()
        rpt.Site = Me.Site
        Return rpt
    End Function
