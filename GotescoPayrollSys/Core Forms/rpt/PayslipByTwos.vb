...
Public Class PayslipByTwos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GotescoPayrollSys.PayslipByTwos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayslipByTwos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayslipByTwos = New PayslipByTwos()
        rpt.Site = Me.Site
        Return rpt
    End Function
