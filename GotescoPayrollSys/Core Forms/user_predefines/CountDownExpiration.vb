Public Class CountDownExpiration
    ...
    Sub CountDownExpiration()
        ...
        n_UsageLeft = EXECQUER("SELECT TIME_TO_SEC(TIMEDIFF(AES_DECRYPT(`Column3`,'.a.'), AES_DECRYPT(`Column2`,'.a.')))" &
                                  " FROM expiration" &
        ...
        If n_UsageLeft <= 0 Then
            ...
            Dim dlgbox =
            MsgBox("Your 30-day trial period has expired." & vbNewLine & vbNewLine &
                   "All the features has been disabled. You can still launch the program but cannot modify any created data." & vbNewLine & vbNewLine &
