...
Public Class printallpayslipotherformat2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "printallpayslipotherformat2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GotescoPayrollSys.printallpayslipotherformat2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedprintallpayslipotherformat2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printallpayslipotherformat2 = New printallpayslipotherformat2()
        rpt.Site = Me.Site
        Return rpt
    End Function
