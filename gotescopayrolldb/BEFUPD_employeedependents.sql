...
-- Dumping structure for trigger gotescopayrolldb_server.BEFUPD_employeedependents
DROP TRIGGER IF EXISTS `BEFUPD_employeedependents`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `BEFUPD_employeedependents` BEFORE UPDATE ON `employeedependents` FOR EACH ROW BEGIN
