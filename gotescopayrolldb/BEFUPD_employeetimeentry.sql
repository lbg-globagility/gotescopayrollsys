...
-- Dumping structure for trigger gotescopayrolldb_server.BEFUPD_employeetimeentry
	...
	IF has_shift = '1' AND isDateNotHoliday = '1' THEN
		...
		ELSE
			...
			IF NEW.TotalDayPay = 0 THEN
				...
				SET NEW.Absent = IFNULL(absent_amount,0);
...
IF NEW.LastUpd != TIMESTAMP('1900-01-01 00:00:00') THEN
