...
-- Dumping structure for procedure gotescopayrolldb_server.DBoard_Age21Dependents
...
,TIMESTAMPDIFF(YEAR,edp.Birthdate,CURDATE()) AS Edad
,DATE_FORMAT(edp.Birthdate,'%c/%e/%Y') 'Birthdate'
