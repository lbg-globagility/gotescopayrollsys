...
-- Dumping structure for procedure gotescopayrolldb_server.EXEC_userupdateleavebalancelog
...
IF hasupdate = 0 THEN
	...
	AND e.LastUpd != @custom_curr_time_stamp; # AND minimum_date <= ADDDATE(e.DateRegularized,INTERVAL 15 YEAR)
