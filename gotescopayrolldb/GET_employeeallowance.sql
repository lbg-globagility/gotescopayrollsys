...
DELIMITER //
CREATE FUNCTION `GET_employeeallowance`(`payp_From` DATE, `payp_To` DATE, `EmployeeRowID` INT, `OrganizationRowID` INT, `Taxable` VARCHAR(1), `Frequency` VARCHAR(50)) RETURNS decimal(10,2)
    DETERMINISTIC
BEGIN
