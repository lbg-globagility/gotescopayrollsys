...
-- Dumping structure for function gotescopayrolldb_latest.INSUPD_employeetimeentries
...
UPDATE 
	...
	,TotalDayPay = (etent_RegularHoursAmount + etent_OvertimeHoursAmount + etent_NightDiffHoursAmount)
