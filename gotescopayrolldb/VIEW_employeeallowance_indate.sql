...
DELIMITER //
CREATE PROCEDURE `VIEW_employeeallowance_indate`(IN `eallow_EmployeeID` INT, IN `eallow_OrganizationID` INT, IN `effectivedatefrom` DATE, IN `effectivedateto` DATE, IN `numweekdays` INT)
    DETERMINISTIC
BEGIN
