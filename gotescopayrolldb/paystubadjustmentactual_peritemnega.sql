...
DROP VIEW IF EXISTS `paystubadjustmentactual_peritemnega`;
DROP TABLE IF EXISTS `paystubadjustmentactual_peritemnega`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `paystubadjustmentactual_peritemnega` AS SELECT
